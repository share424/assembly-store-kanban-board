...
class M_Order extends CI_Model
{
    ...
    {
        return $this->db->select("orders.id, component.name, quantity, start_date, end_date, status, product.name as product, product.id as product_id, component.id as component_id, stock, actual_start, actual_finish, visible, orders.level, done")
